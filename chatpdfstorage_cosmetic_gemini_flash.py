...
def get_conversational_chain():
    ...
    #model = ChatGoogleGenerativeAI('gemini-1.5-flash') #  If you are getting quota limit for pro modle use this model
    #model = ChatGoogleGenerativeAI("gemini-1.5-flash", temperature=0.5, max_output_tokens=1024)
    model = ChatGoogleGenerativeAI(model="gemini-1.5-flash", temperature=0.5, max_output_tokens=1024)
