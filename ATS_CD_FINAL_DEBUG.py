...
def input_text(uploaded_file):
    ...
    print(f"Extracted Text: {text[:1000]}")  # Print the first 1000 characters for debugging
    return text
...
def calculate_jd_match(job_description, resume):
    ...
    print(f"JD Skills: {jd_skills}, Resume Skills: {resume_skills}, Match Percentage: {match_percentage}")  # Debugging
...
def assess_position_match(jd_match, resume_text, job_description_text):
    ...
    print(f"JD Match: {jd_match}, Key Skills Present: {key_skills_present}")  # Debugging
...
def extract_education(text):
    ...
    print(f"Education Matches: {education_matches}, Education Match Percentage: {education_match}")  # Debugging
...
def assess_stability(resume_text):
    ...
    print(f"Date Entities: {date_entities}, Stability Percentage: {stability_percentage}")  # Debugging
